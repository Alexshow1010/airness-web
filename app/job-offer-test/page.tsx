...
import styles from "./job-offer.module.css";
// 引入翻譯 Hook
import { useTranslation } from "../../hooks/useTranslation";

export default function JobOfferScamPage() {
  ...
  return (
    <main className={styles.container}>
      <motion.div initial="hidden" animate="visible" variants={springVariant} className={styles.header}>
        <div className={styles.tag}>{t("job_tag")}</div>
      ...
      <div className={styles.contentWrapper} style={{ perspective: "1000px" }}>
        ...
        >
          <h2>{t("job_c1_h2")}</h2>
          <p>{t("job_c1_p1")}</p>
          <p>{t("job_c1_p2")} <strong>{t("job_c1_strong")}</strong></p>
        </motion.article>
        ...
        >
          <h2>{t("job_c2_h2")}</h2>
          <p>{t("job_c2_p1")}</p>
          <p>{t("job_c2_p2")} <strong>{t("job_c2_strong")}</strong></p>
          <p>{t("job_c2_p3")}</p>
        </motion.article>
        ...
        >
          <h2>{t("job_c3_h2")}</h2>
          <p>{t("job_c3_p1")}</p>
          <p>{t("job_c3_p2")} <strong>{t("job_c3_strong")}</strong></p>
        </motion.article>
