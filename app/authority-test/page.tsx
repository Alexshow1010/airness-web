...
export default function AuthorityScamPage() {
  ...
  return (
    <main className={styles.container}>
      <motion.div initial="hidden" animate="visible" variants={springVariant} className={styles.header}>
        <div className={styles.tag}>{t("auth_tag")}</div>
      ...
      <div className={styles.contentWrapper} style={{ perspective: "1000px" }}>
        ...
        >
          <h2>{t("auth_c1_h2")}</h2>
          <p>{t("auth_c1_p1")}</p>
          <p>{t("auth_c1_p2")} <strong>{t("auth_c1_strong")}</strong></p>
          <p>{t("auth_c1_p3")}</p>
        </motion.article>
        ...
        >
          <h2>{t("auth_c2_h2")}</h2>
          <p>{t("auth_c2_p1")}</p>
          <p>{t("auth_c2_p2")} <strong>{t("auth_c2_strong")}</strong></p>
          <p>{t("auth_c2_p3")}</p>
        </motion.article>
        ...
        >
          <h2>{t("auth_c3_h2")}</h2>
          <p>{t("auth_c3_p1")}</p>
          <p>{t("auth_c3_p2")} <strong>{t("auth_c3_strong")}</strong></p>
          <p>{t("auth_c3_p3")}</p>
        </motion.article>
