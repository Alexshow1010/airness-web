  ...
  return (
    <main className={styles.container}>
      <motion.div initial="hidden" animate="visible" variants={springVariant} className={styles.header}>
        <div className={styles.tag}>{t("inv_tag")}</div>
      ...
      <div className={styles.contentWrapper} style={{ perspective: "1000px" }}>
        ...
        >
          <h2>{t("inv_c1_h2")}</h2>
          <p>{t("inv_c1_p1")}</p>
          <p>{t("inv_c1_p2")} <strong>{t("inv_c1_strong")}</strong></p>
        </motion.article>
        ...
        >
          <h2>{t("inv_c2_h2")}</h2>
          <p>{t("inv_c2_p1")}</p>
          <p>{t("inv_c2_p2")} <strong>{t("inv_c2_strong")}</strong></p>
        </motion.article>
        ...
        >
          <h2>{t("inv_c3_h2")}</h2>
          <p>{t("inv_c3_p1")}</p>
          <p>{t("inv_c3_p2")} <strong>{t("inv_c3_strong")}</strong></p>
          <p>{t("inv_c3_p3")}</p>
        </motion.article>
